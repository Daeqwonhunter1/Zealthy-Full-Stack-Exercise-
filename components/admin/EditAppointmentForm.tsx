...
export default function EditAppointmentForm({appointment}: AppointmentFormProps) {
  ...
  const [repeatEndsOn, setRepeatEndsOn] = useState(
    appointment.repeatEndsOn
      ? new Date(appointment.repeatEndsOn).toISOString().slice(0, 10)
      : ""
  );
